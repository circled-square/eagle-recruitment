...
/* USER CODE BEGIN PV */
//note: the "private" variables in the above block, specifically htim2 and hadc1, are not actually private at all since i exported
//them in the main.h file under the "exported constants" block
/* USER CODE END PV */
